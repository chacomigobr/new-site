...
export default function DownloadApp() {
  return (
    <div className="flex flex-row justify-around w-full h-screen bg-green-700	px-28 py-16 md:px-28">
      ...
      <div className=" flex flex-row justify-around align-middle w-full h-auto">
        ...
        <div className="grid grid-cols-5 gap-4">
          ...
          <div className="flex flex-row justify-center col-span-3">
            <Image src="/images/telefone.png" width="250" height="200" className="" />
          </div>
