...
export default function News() {
  return (
    <div className="flex flex-col bg-green-100 w-full h-screen px-16 py-16">
      ...
      <div className="flex flex-row align-center justify-center">
        ...
        <div className=" rounded-md shadow-xl  flex flex-col justify-around bg-green-200 m-8 p-8">
          ...
          <div>
            <h1 className="text-xl text-center md:text-left font-bold text-gray-700 pt-2 pb-1">Novidades para você</h1>
