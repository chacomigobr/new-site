...
export default function People() {
  return (
    <div className=" flex flex-col justify-around align-middle w-full bg-gray-100	 py-20 md:px-28 md:py-20 ">
      <div className=" flex flex-row justify-around align-middle w-full">
        <h1 className="text-4xl  font-bold text-gray-700 text-center pb-10 w-full">Nosso Time </h1>
      </div>

      <div className=" flex flex-col-reverse md:flex-row justify-around w-full h-auto " >
        <div className=" rounded-md shadow-xl  flex flex-col justify-around bg-gray-200 m-8 p-8">
