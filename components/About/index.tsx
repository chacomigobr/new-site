  ...
  return (
    <div className="bg-white ">
      <div className="flex flex-col justify-around w-full h-auto bg-gray-100 px-28 py-28 ">
        <h1 className="text-4xl text-center font-bold text-gray-600 pb-10">
          Sobre
        </h1>
        ...
        <div className=" flex flex-col md:flex-row justify-around w-full h-auto px-16 py-16 bg-gray-200 ">
          ...
          <div>
            ...
            <h3 className="text-sm leading-6	text-left w-auto md:w-96 font-bold text-gray-500">
        ...
        <div className=" flex flex-col-reverse md:flex-row justify-around w-full h-auto px-16 py-16 bg-gray-100">
          <div>
            <h1 className="text-xl text-center font-bold text-gray-600  py-4">
