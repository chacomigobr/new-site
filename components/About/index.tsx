  ...
  return (
    <div className=" flex flex-col justify-around w-full h-auto bg-white	px-28 py-28 ">
      ...
      <div className=" flex flex-row justify-around w-full h-auto px-16 py-16 ">
        <div className="flex flex-row justify-between w-96 h-60 bg-red-200">

        </div>
        <div>
          <h1 className="text-2xl text-center font-bold text-gray-700">Nossa missão</h1>

          <h3 className="text-xl text-center w-96 font-bold text-gray-700">
      ...
      <div className=" flex flex-row justify-around w-full h-auto px-16 py-16 ">
        <div>
          <h1 className="text-2xl text-center font-bold text-gray-700">Onde queremos chegar</h1>
      ...
      <div className=" flex flex-row justify-around w-full h-auto px-16 py-16 ">
        ...
        <div>
          <h1 className="text-2xl text-center font-bold text-gray-700">Quem somos?</h1>
          <h3 className="text-xl text-center w-96 font-bold text-gray-700">
