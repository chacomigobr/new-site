...
export default function About() {
  return (
    <div className="bg-green-100 ">
      <div className="flex flex-col justify-around w-full  bg-green-300 
        pt-16 pb-16 md:px-28 md:py-28 md:bg-green-100">

        <h1 className="text-4xl text-center font-bold text-gray-700 
        md:text-green-600 pb-0 md:pb-16">
          Sobre
        </h1>

        <div className="flex flex-col-reverse md:flex-row justify-around w-full 
           px-8 py-16 md:px-8 md:py-16 bg-green-300">
          <div className=" flex flex-row justify-center w-auto md:w-96  h-60">
            <Image src="/images/latte.png" width="250" height="200" />
          </div>
          ...
          <div className="p-2 flex flex-col justify-center">
           ...
           md:text-left w-auto md:w-96 font-normal text-green-600">
        ...
        <div className="flex flex-col md:flex-row justify-around w-full 
         px-8 py-16 md:px-8 md:py-16 bg-green-200 ">
          ...
          <div className="flex flex-row justify-center w-auto md:w-96  h-60 ">
            <Image src="/images/foguete.png" width="250" height="200" />
          </div>
        ...
        <div className="flex flex-col-reverse md:flex-row justify-around w-full 
         px-8 py-16 md:px-8 md:py-16 bg-green-300">
          <div className="flex flex-row justify-center w-auto md:w-96 h-60 ">
            <Image src="/images/dart.png" width="250" height="200" />
          </div>
          ...
          <div className="p-2 flex flex-col justify-center">
            ...
            <h3 className="text-md leading-6 pb-10 md:text-left w-auto md:w-96  font-normal text-green-600">
